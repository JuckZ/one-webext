  ...
  <el-config-provider :locale="locale">
    ...
    <el-form inline>
      ...
      <el-form-item>
        ...
        <el-button @click="stopCheck">
          停止检测
        </el-button>
        <el-button @click="resetCheck">
          重置
        </el-button>
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      <el-table-column label="失效书签链接">
        <template #default="{ row }">
          <div v-show="row.editing" class="flex-box">
            <el-input
              v-model="row.url"
              v-focus
              placeholder="请输入新的链接"
            ...
            /> &nbsp;
            <el-button @click="row.editing = false">
              取消
            </el-button>
          </div>
          <div v-show="!row.editing" class="flex-box flex-box--end">
            <el-link
              class="link-box"
              :href="row.url"
              target="_blank"
